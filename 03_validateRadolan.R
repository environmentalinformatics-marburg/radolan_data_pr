...
#install.packages("devtools",  repos="http://cran.rstudio.com/", dependencies=TRUE, lib="C:/Program Files/R/library/")
library(devtools)

#install.packages("remotes")
#remotes::install_version("SDMTools", "1.1-221")
#install.packages("SDMTools", dependencies = TRUE, lib="C:/Program Files/R/library/")
